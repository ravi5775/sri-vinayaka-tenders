    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="glass-card p-6">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-5">
          <h2 className="text-2xl font-bold text-foreground tracking-tight">{t('All Loans')}</h2>
          <div className="flex items-center gap-2">
            <button onClick={() => navigate('/loan/new')} className="btn btn-primary">
              <Plus size={18} className="mr-2" />
              {t('Add New Loan')}
            </button>
            <button onClick={() => generateCSV(filteredLoans, t)} className="btn btn-secondary">
